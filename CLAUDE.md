...
- ✅ **續：手機版贊助 logo 二改「全部一次呈現、不捲軸」**（comp `63ec031`，取代下方單排橫捲版）：使用者拍板不要捲軸——卡片再縮小（**最終版 comp `sponsor-logo-4up`：logo 放大 20% 至 26×79、內距縮 2×4、卡估寬87+gap4——各機型皆一排 4 個（4+3+3 三排 124px/約18%）**；歷次：22×66 一排4-5個 `4c08476` ← 24×74 `63ec031`）、多排**真均分**置中（前幾排多1個：10個/容3 → 3+3+2+2，順修原「3+3+3+1」不均問題、桌面版同受惠），整區 ≦ 手機畫面約 1/4（實測 360px→162px/23%、390/412px→126px/18%，無捲軸）。電腦版尺寸不變。
