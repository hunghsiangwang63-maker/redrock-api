...
- ✅ **續：手機版贊助 logo 二改「全部一次呈現、不捲軸」**（comp `63ec031`，取代下方單排橫捲版）：使用者拍板不要捲軸——卡片再縮小（**再依使用者要求縮至一排 4-5 個**，comp `4c08476`：logo 22×66、卡估寬78——360/390px→4+3+3 三排118px/17%、412px→5+5 兩排85px/12%）、多排**真均分**置中（前幾排多1個：10個/容3 → 3+3+2+2，順修原「3+3+3+1」不均問題、桌面版同受惠），整區 ≦ 手機畫面約 1/4（實測 360px→162px/23%、390/412px→126px/18%，無捲軸）。電腦版尺寸不變。
