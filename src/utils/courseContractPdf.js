  ...
  return [
    ...
    { text: '3. 終止課程、轉讓與解約', margin: [0, 1, 0, 1], fontSize: T },
    {
      ul: [
        ...
        '若甲方因個人因素終止本課程，得申請退費',
        { text: '(1) 退費金額計算公式：', bold: true, margin: [0, 1, 0, 1] },
        { ul: ['退費金額=剩餘堂數價金−手續費', '每堂單價：課程費用÷總堂數', '剩餘堂數：總堂數−已開課堂數（不論學員實際有無出席或請假，皆以已開課天數計算）。'] },
        { text: '(2) 手續費比例：', bold: true, margin: [0, 1, 0, 1] },
        { ul: [
    ...
    { text: [{ text: '4. 乙方服務之異動通知：', bold: true }, '乙方所提供服務內容與時間如有異動，須事先通知，且應與原定開始服務時間相距24個小時以上，其通知方式約定如下：'], margin: [0, 1, 0, 1], fontSize: T },
    ...
    { text: [{ text: '11. 消費資訊及廣告：', bold: true }, '乙方之廣告，均為契約內容。乙方應確保其廣告內容真實，其對甲方所應負義務不得低於前項廣告內容。'], margin: [0, 1, 0, 3], fontSize: T },
    { text: [{ text: '12. 合意管轄：', bold: true }, '因本契約發生訴訟時，雙方同意以新竹地方法院為第一審管轄法院，但不得排除消費者保護法第四十七條或民事訴訟法第二十八條第二項、第四百三十六條之九規定之小額訴訟管轄法院之適用。'], margin: [0, 1, 0, 1], fontSize: T },
  ];
}
