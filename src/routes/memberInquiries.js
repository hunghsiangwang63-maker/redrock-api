...
const DEFAULT_FAQ = [
  ...
  { id: 'onboarding', question: '入場前為什麼要簽署文件、安排墜落測驗？', answer: '首次入場需完成「風險安全聲明書」與「墜落測驗同意書」簽署，並到館完成墜落測驗（由現場人員登記通過與否）。全部完成後即可自助入場，不需每次臨櫃辦理。' },
  { id: 'no-phone', question: '手機沒電或忘記帶會員證，要怎麼入場？', answer: '可請櫃檯人員以您的電話號碼查詢會員資料協助入場，不需出示手機 QR code。' },
  { id: 'course-leave-makeup', question: '課程請假後可以補課嗎？', answer: '課程依各班規則有請假次數上限與請假時限（需於課前一定時數內申請）。請假成立後系統會依規則發放補課資格，補課需在課程結束後一定天數內、於相容班別的其他場次完成。詳細規則可在「我的課程」點選課卡上的「📋 課程規則」查看。' },
