...
// ── 建立/更新 Waiver ─────────────────────────────────────────────
const signWaiver = async ({ memberId, memberName, isMinor, signatureData, parentEmail, parentName, parentPhone, parentRelation, staffId, ip }) => {
  const db = getDb();
